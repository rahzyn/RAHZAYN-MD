...
zokou({
  ...
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr Rahzayn хmd σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr Rahzayn md σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr Rahzayn хmd σwnє");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or 𝓡𝓪𝓱𝔃𝓪𝔂𝓷-𝓜𝓭❤ owner.* 🥰,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or 😘RAHZAYN-MD😘 owner.* 🥰,,idiot");
  }
