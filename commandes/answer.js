...
zokou({nomCom:"rahzayn",reaction:"📡",categorie:"IA"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  zokou({ nomCom: "zayn", reaction: "📡", categorie: "IA" }, async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      let caption = '*powered by 𝑹𝑨𝑯𝒁𝑨𝒀𝑵-𝑴𝑫 😜❤*';
